...
public class Joystick : MonoBehaviour,IDragHandler,IPointerUpHandler,IPointerDownHandler {
    ...
    public virtual void OnDrag(PointerEventData ped)
    {
        ...
        if (RectTransformUtility.ScreenPointToLocalPointInRectangle(bgImg.rectTransform, ped.position, ped.pressEventCamera, out pos))
        {
            ...
            //Rotation according joystick
            controller.gameObject.transform.LookAt(controller.gameObject.transform.position + inputVector * Rotatespeed * Time.deltaTime);
    ...
    public float Vertical()
    {
        if (inputVector.z != 0)
            ...
            //return controller.gameObject.transform.Translate(Vector3.forward * Time.deltaTime);
           // return 1;
